...
/* for My Hypercalls */
unsigned int hvm_time_slope_force = 0;  /* for hypercall do_time_slope and do_disable_time_slope. */
int hvm_guest_time_slope = 0;  /* slope of hvm_get_guest_time() */
...
/*
 * My function to change the speed of guest time flow in vpt.c
 */
int force_hvm_guest_time_slope(int slope)
{
    /*
    printk("Slope is : %d\n", slope);
    */
    hvm_guest_time_slope = slope;

    hvm_time_slope_force = 1;
    

    return 0;
}

int disable_hvm_guest_time_slope(void)
{
    hvm_time_slope_force = 0;
    hvm_guest_time_slope = 0;

    if( hvm_time_slope_force == 0 && hvm_guest_time_slope == 0 )
	printk("The time slope part in vpt.c has been disabled!\n");
